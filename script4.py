...
inputFeature2 = arcpy.GetParameterAsText(1)
inputDaySpan1 = int(arcpy.GetParameterAsText(2))
inputDaySpan2 = int(arcpy.GetParameterAsText(3))
...
def Step2Func(_inputFeature1,_inputFeature2,_outputFeature,daySpan):
    ...
    arcpy.Delete_management(inShapePath1)
    return True
    
if __name__ == "__main__":
    arcpy.AddMessage("%s:%s"%(str(1),inputFeature1))
    result1 = Step1Func(inputFeature1,"step1_0",inputDaySpan1)
    result2 = Step1Func(inputFeature2,"step1_1",inputDaySpan1)
    result3 = Step2Func(result1,result2,outputFeature,inputDaySpan2)
    arcpy.Delete_management(result1)
    arcpy.Delete_management(result2)